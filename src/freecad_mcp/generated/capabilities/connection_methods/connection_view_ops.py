...
def _screenshot_from_routed(routed: Any) -> str | None:
    if isinstance(routed, str):
        return routed
    if not isinstance(routed, dict):
        return None
    if routed.get("success") is False:
        return None
    for key in ("screenshot", "image", "result", "data"):
...
def get_active_screenshot(
    ...
    if routed is not None:
        # Never fall through to plain RPC once the v2 lane was entered —
        # that would bypass session recovery.
        return _screenshot_from_routed(routed)
    try:
...
def capture_view_sequence(
    ...
    routed = conn._invoke_mutation_v2(
        ...
        operation_name="Capture view sequence",
    )
    if routed is not None:
        return routed
    try:
...
def capture_view_sequence_to_disk(
    ...
    routed = conn._invoke_mutation_v2(
        ...
        operation_name="Capture view sequence to disk",
    )
    if routed is not None:
        return routed
    try:
...
def activate_document(conn, doc_name: str) -> dict[str, Any]:
    routed = conn._invoke_mutation_v2(
        ...
        {"doc_name": doc_name},
        document_names=(doc_name,),
        operation_name="Activate document",
    )
    if routed is not None:
        return routed
...
def set_tree_expanded(
    ...
    routed = conn._invoke_mutation_v2(
        ...
        document_names=(doc_name,),
        operation_name="Set tree expanded",
    )
    if routed is not None:
        return routed
...
def select_subshapes(
    ...
    routed = conn._invoke_mutation_v2(
        ...
        document_names=(doc_name,),
        operation_name="Select subshapes",
    )
    if routed is not None:
        return routed
...
def set_section_view(
    ...
    routed = conn._invoke_mutation_v2(
        ...
        operation_name="Set section view",
    )
    if routed is not None:
        return routed
