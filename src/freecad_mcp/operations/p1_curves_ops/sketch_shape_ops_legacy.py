...
def sketch_add_ellipse_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_add_ellipse.py.txt",
        angle=repr(angle),
        cx=repr(cx),
        cy=repr(cy),
...
def sketch_add_arc_of_ellipse_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_add_arc_of_ellipse.py.txt",
        angle=repr(angle),
        cx=repr(cx),
        cy=repr(cy),
        major_radius=repr(major_radius),
...
def sketch_add_slot_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_add_slot.py.txt",
        x1=repr(x1),
        y1=repr(y1),
        x2=repr(x2),
        y2=repr(y2),
...
def sketch_add_regular_polygon_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_add_regular_polygon.py.txt",
        cx=repr(cx),
        cy=repr(cy),
        radius=repr(radius),
        sides=repr(sides),
...
def sketch_add_parametric_curve_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_add_parametric_curve.py.txt",
...
def sketch_import_points_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_import_points.py.txt",
        points=pt_str,
        construction=repr(construction),
    )
    return _run_code(freecad, only_text_feedback, "\n".join(lines),
...
def sketch_toggle_construction_operation(
    ...
    lines = _sk_preamble(doc_name, sketch_name) + render_template_lines(
        "legacy/p1_curves/sketch_toggle_construction.py.txt",
