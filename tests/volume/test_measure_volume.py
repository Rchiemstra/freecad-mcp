"""Unit coverage for the typed ``measure_volume`` query slice."""
...
def test_measure_volume_observed_without_native_mutation():
    events: list[str] = []
    ...
    with patch.object(measure_io_actions, "measure_volume", return_value=payload):
        result = run_measure_volume(collab, "Doc", "Box")
