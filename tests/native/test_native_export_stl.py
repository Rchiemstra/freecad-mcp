"""Native qualification for typed ``export_stl``."""
...
def test_export_stl_native_success_publishes():
    check_export_success("export_stl", _KIND, _RUN_ARGS)


def test_export_stl_native_missing_document_keeps_typed_error():
    check_export_missing("export_stl", _RUN_ARGS_MISSING)
