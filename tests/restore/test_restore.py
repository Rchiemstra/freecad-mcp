"""Unit coverage for the typed ``restore`` mutation slice."""
...
def test_restore_runs_apply_recompute_inspect_validate_then_commits():
    events: list[str] = []
...
def test_unknown_or_contradictory_native_evidence_cannot_release_success():
    from addon.FreeCADMCP.rpc_server.methods.cad_methods_ops.restore_mutation import (
        _restore_native_result,
