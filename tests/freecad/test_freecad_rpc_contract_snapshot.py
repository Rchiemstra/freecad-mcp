...
_PARAMETER_SCHEMAS: dict[str, dict] = {
    ...
    "center_approx": {"type": ["array", "null", "object"]},
    "direction_approx": {"type": ["array", "null", "object"]},
    "geometry": {"type": "array"},
    "normal_approx": {"type": ["array", "null", "object"]},
    ...
    "expected_undo_count": {"type": "integer"},
    "expected_undo_head": {"type": "string"},
    "expected_redo_count": {"type": "integer"},
    "expected_redo_head": {"type": "string"},
