...
def test_create_document_architecture_gate_passes_the_production_path() -> None:
...
def test_gate_rejects_legacy_policy_sins_via_source_override() -> None:
    ...
    assert any("lifecycle API (newDocument)" in item for item in scan_create_document_architecture(
