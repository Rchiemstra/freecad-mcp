"""Unit coverage for the typed ``relink_references`` mutation slice."""
...
def test_relink_references_runs_apply_recompute_inspect_validate_then_commits():
    events: list[str] = []
...
def test_unknown_or_contradictory_native_evidence_cannot_release_success():
    from addon.FreeCADMCP.rpc_server.methods.cad_methods_ops.relink_references_mutation import (
        _relink_references_native_result,
