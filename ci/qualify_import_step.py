...
PYTHON_TESTS = (
    "tests/test_import_step.py",
    "tests/test_import_step_response.py",
    "tests/test_import_step_contract_gate.py",
    "tests/test_import_step_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_import_step.py",)
    else:
