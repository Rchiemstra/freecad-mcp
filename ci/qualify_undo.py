...
PYTHON_TESTS = (
    "tests/undo/test_undo.py",
    "tests/undo/test_undo_response.py",
    "tests/undo/test_undo_contract_gate.py",
    "tests/undo/test_undo_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_undo.py",)
    else:
