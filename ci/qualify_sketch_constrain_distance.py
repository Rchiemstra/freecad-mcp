...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_distance.py",
    "tests/test_sketch_constrain_distance_response.py",
    "tests/test_sketch_constrain_distance_contract_gate.py",
    "tests/test_sketch_constrain_distance_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_distance.py",)
    else:
