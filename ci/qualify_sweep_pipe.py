...
PYTHON_TESTS = (
    "tests/test_sweep_pipe.py",
    "tests/test_sweep_pipe_response.py",
    "tests/test_sweep_pipe_contract_gate.py",
    "tests/test_sweep_pipe_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sweep_pipe.py",)
    else:
