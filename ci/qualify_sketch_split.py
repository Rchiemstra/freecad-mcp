...
PYTHON_TESTS = (
    "tests/test_sketch_split.py",
    "tests/test_sketch_split_response.py",
    "tests/test_sketch_split_contract_gate.py",
    "tests/test_sketch_split_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_split.py",)
    else:
