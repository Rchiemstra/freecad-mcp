"""Repeatable acceptance lanes for the typed ``sketch_split`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_split.py",
    "tests/sketch/test_sketch_split_response.py",
    "tests/sketch/test_sketch_split_contract_gate.py",
    "tests/sketch/test_sketch_split_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_split.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_split_contract.py"],
            cwd=root,
            check=False,
        )
