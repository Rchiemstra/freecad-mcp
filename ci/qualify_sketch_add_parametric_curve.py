...
PYTHON_TESTS = (
    "tests/test_sketch_add_parametric_curve.py",
    "tests/test_sketch_add_parametric_curve_response.py",
    "tests/test_sketch_add_parametric_curve_contract_gate.py",
    "tests/test_sketch_add_parametric_curve_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_parametric_curve.py",)
    else:
