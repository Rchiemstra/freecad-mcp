"""Repeatable acceptance lanes for the typed ``sketch_add_parametric_curve`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_add_parametric_curve.py",
    "tests/sketch/test_sketch_add_parametric_curve_response.py",
    "tests/sketch/test_sketch_add_parametric_curve_contract_gate.py",
    "tests/sketch/test_sketch_add_parametric_curve_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_add_parametric_curve.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_add_parametric_curve_contract.py"],
            cwd=root,
            check=False,
        )
