"""Repeatable acceptance lanes for the typed ``sketch_attach`` implementation.
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_attach.py",
    "tests/sketch/test_sketch_attach_response.py",
    "tests/sketch/test_sketch_attach_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/sketch/test_sketch_attach_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_attach.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_attach_contract.py"],
            cwd=root,
            check=False,
        )
