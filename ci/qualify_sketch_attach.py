...
PYTHON_TESTS = (
    "tests/test_sketch_attach.py",
    "tests/test_sketch_attach_response.py",
    "tests/test_sketch_attach_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/test_sketch_attach_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_attach.py",)
    else:
