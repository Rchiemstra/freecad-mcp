...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_coincident.py",
    "tests/test_sketch_constrain_coincident_response.py",
    "tests/test_sketch_constrain_coincident_contract_gate.py",
    "tests/test_sketch_constrain_coincident_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_coincident.py",)
    else:
