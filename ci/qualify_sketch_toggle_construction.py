"""Repeatable acceptance lanes for the typed ``sketch_toggle_construction`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_toggle_construction.py",
    "tests/sketch/test_sketch_toggle_construction_response.py",
    "tests/sketch/test_sketch_toggle_construction_contract_gate.py",
    "tests/sketch/test_sketch_toggle_construction_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_toggle_construction.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_toggle_construction_contract.py"],
            cwd=root,
            check=False,
        )
