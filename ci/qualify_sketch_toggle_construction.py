...
PYTHON_TESTS = (
    "tests/test_sketch_toggle_construction.py",
    "tests/test_sketch_toggle_construction_response.py",
    "tests/test_sketch_toggle_construction_contract_gate.py",
    "tests/test_sketch_toggle_construction_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_toggle_construction.py",)
    else:
