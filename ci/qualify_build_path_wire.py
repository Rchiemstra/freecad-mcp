"""Repeatable acceptance lanes for the typed ``build_path_wire`` mutation."""
...
PYTHON_TESTS = (
    "tests/build/test_build_path_wire.py",
    "tests/build/test_build_path_wire_response.py",
    "tests/build/test_build_path_wire_contract_gate.py",
    "tests/build/test_build_path_wire_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_build_path_wire.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_build_path_wire_contract.py"],
            cwd=root,
            check=False,
        )
