...
PYTHON_TESTS = (
    "tests/test_build_path_wire.py",
    "tests/test_build_path_wire_response.py",
    "tests/test_build_path_wire_contract_gate.py",
    "tests/test_build_path_wire_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_build_path_wire.py",)
    else:
