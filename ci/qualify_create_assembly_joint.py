...
PYTHON_TESTS = (
    "tests/test_create_assembly_joint.py",
    "tests/test_create_assembly_joint_response.py",
    "tests/test_create_assembly_joint_contract_gate.py",
    "tests/test_create_assembly_joint_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_create_assembly_joint.py",)
    else:
