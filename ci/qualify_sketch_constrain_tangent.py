...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_tangent.py",
    "tests/test_sketch_constrain_tangent_response.py",
    "tests/test_sketch_constrain_tangent_contract_gate.py",
    "tests/test_sketch_constrain_tangent_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_tangent.py",)
    else:
