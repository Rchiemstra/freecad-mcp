"""Repeatable acceptance lanes for the typed ``sketch_constrain_tangent`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_constrain_tangent.py",
    "tests/sketch/test_sketch_constrain_tangent_response.py",
    "tests/sketch/test_sketch_constrain_tangent_contract_gate.py",
    "tests/sketch/test_sketch_constrain_tangent_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_constrain_tangent.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_constrain_tangent_contract.py"],
            cwd=root,
            check=False,
        )
