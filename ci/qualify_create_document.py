...
PYTHON_TESTS = (
    ...
    "tests/test_create_document_response.py",
    "tests/test_create_document_contract_gate.py",
    "tests/test_create_document_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_create_document.py",)
    else:
