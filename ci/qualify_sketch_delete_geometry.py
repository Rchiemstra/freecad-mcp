"""Repeatable acceptance lanes for the typed ``sketch_delete_geometry`` implementation.
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_delete_geometry.py",
    "tests/sketch/test_sketch_delete_geometry_response.py",
    "tests/sketch/test_sketch_delete_geometry_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/sketch/test_sketch_delete_geometry_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_delete_geometry.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_delete_geometry_contract.py"],
            cwd=root,
            check=False,
        )
