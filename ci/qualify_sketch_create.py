...
PYTHON_TESTS = (
    "tests/test_sketch_create.py",
    "tests/test_sketch_create_response.py",
    "tests/test_sketch_create_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/test_sketch_create_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_create.py",)
    else:
