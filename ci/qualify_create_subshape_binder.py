...
PYTHON_TESTS = (
    "tests/test_create_subshape_binder.py",
    "tests/test_create_subshape_binder_response.py",
    "tests/test_create_subshape_binder_contract_gate.py",
    "tests/test_create_subshape_binder_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_create_subshape_binder.py",)
    else:
