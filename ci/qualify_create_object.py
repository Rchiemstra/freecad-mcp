...
PYTHON_TESTS = (
    ...
    "tests/test_create_object_response.py",
    "tests/test_create_object_contract_gate.py",
    "tests/test_create_object_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_create_object.py",)
    else:
