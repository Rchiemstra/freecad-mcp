...
PYTHON_TESTS = (
    ...
    "tests/test_export_stl_response.py",
    "tests/test_export_stl_contract_gate.py",
    "tests/test_export_stl_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_export_stl.py",)
    else:
