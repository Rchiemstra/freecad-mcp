...
PYTHON_TESTS = (
    "tests/test_edit_object.py",
    "tests/test_edit_object_response.py",
    "tests/test_edit_object_contract_gate.py",
    "tests/test_edit_object_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_edit_object.py",)
    else:
