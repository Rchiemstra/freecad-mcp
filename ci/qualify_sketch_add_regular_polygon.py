...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_add_regular_polygon.py",
    "tests/sketch/test_sketch_add_regular_polygon_response.py",
    "tests/sketch/test_sketch_add_regular_polygon_contract_gate.py",
    "tests/sketch/test_sketch_add_regular_polygon_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_add_regular_polygon.py",)
    else:
