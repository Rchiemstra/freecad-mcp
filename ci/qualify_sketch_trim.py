"""Repeatable acceptance lanes for the typed ``sketch_trim`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_trim.py",
    "tests/sketch/test_sketch_trim_response.py",
    "tests/sketch/test_sketch_trim_contract_gate.py",
    "tests/sketch/test_sketch_trim_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_trim.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_trim_contract.py"],
            cwd=root,
            check=False,
        )
