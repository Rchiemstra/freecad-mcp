...
PYTHON_TESTS = (
    "tests/test_sketch_trim.py",
    "tests/test_sketch_trim_response.py",
    "tests/test_sketch_trim_contract_gate.py",
    "tests/test_sketch_trim_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_trim.py",)
    else:
