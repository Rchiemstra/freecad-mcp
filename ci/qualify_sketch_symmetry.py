"""Repeatable acceptance lanes for the typed ``sketch_symmetry`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_symmetry.py",
    "tests/sketch/test_sketch_symmetry_response.py",
    "tests/sketch/test_sketch_symmetry_contract_gate.py",
    "tests/sketch/test_sketch_symmetry_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_symmetry.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_symmetry_contract.py"],
            cwd=root,
            check=False,
        )
