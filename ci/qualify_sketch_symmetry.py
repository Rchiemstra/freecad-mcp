...
PYTHON_TESTS = (
    "tests/test_sketch_symmetry.py",
    "tests/test_sketch_symmetry_response.py",
    "tests/test_sketch_symmetry_contract_gate.py",
    "tests/test_sketch_symmetry_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_symmetry.py",)
    else:
