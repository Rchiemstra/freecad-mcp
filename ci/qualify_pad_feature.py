...
PYTHON_TESTS = (
    "tests/test_pad_feature.py",
    "tests/test_pad_feature_response.py",
    "tests/test_pad_feature_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/test_pad_feature_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_pad_feature.py",)
    else:
