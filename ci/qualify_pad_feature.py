"""Repeatable acceptance lanes for the typed ``pad_feature`` implementation.
...
PYTHON_TESTS = (
    "tests/pad/test_pad_feature.py",
    "tests/pad/test_pad_feature_response.py",
    "tests/pad/test_pad_feature_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/pad/test_pad_feature_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_pad_feature.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_pad_feature_contract.py"],
            cwd=root,
            check=False,
        )
