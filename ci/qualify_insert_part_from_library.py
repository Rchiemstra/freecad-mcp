...
PYTHON_TESTS = (
    "tests/test_insert_part_from_library.py",
    "tests/test_insert_part_from_library_response.py",
    "tests/test_insert_part_from_library_contract_gate.py",
    "tests/test_insert_part_from_library_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_insert_part_from_library.py",)
    else:
