...
PYTHON_TESTS = (
    "tests/translate/test_translate.py",
    "tests/translate/test_translate_response.py",
    "tests/translate/test_translate_contract_gate.py",
    "tests/translate/test_translate_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_translate.py",)
    else:
