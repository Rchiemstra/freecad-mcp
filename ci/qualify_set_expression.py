...
PYTHON_TESTS = (
    "tests/test_set_expression.py",
    "tests/test_set_expression_response.py",
    "tests/test_set_expression_contract_gate.py",
    "tests/test_set_expression_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_set_expression.py",)
    else:
