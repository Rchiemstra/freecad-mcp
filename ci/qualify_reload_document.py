...
PYTHON_TESTS = (
    "tests/test_reload_document.py",
    "tests/test_reload_document_response.py",
    "tests/test_reload_document_contract_gate.py",
    "tests/test_reload_document_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_reload_document.py",)
    else:
