...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_perpendicular.py",
    "tests/test_sketch_constrain_perpendicular_response.py",
    "tests/test_sketch_constrain_perpendicular_contract_gate.py",
    "tests/test_sketch_constrain_perpendicular_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_perpendicular.py",)
    else:
