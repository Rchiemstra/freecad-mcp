...
PYTHON_TESTS = (
    "tests/test_sketch_add_polyline.py",
    "tests/test_sketch_add_polyline_response.py",
    "tests/test_sketch_add_polyline_contract_gate.py",
    "tests/test_sketch_add_polyline_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_polyline.py",)
    else:
