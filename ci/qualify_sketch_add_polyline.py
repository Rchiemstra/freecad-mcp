"""Repeatable acceptance lanes for the typed ``sketch_add_polyline`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_add_polyline.py",
    "tests/sketch/test_sketch_add_polyline_response.py",
    "tests/sketch/test_sketch_add_polyline_contract_gate.py",
    "tests/sketch/test_sketch_add_polyline_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_add_polyline.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_add_polyline_contract.py"],
            cwd=root,
            check=False,
        )
