"""Repeatable acceptance lanes for the typed ``sketch_add_arc_of_ellipse`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_add_arc_of_ellipse.py",
    "tests/sketch/test_sketch_add_arc_of_ellipse_response.py",
    "tests/sketch/test_sketch_add_arc_of_ellipse_contract_gate.py",
    "tests/sketch/test_sketch_add_arc_of_ellipse_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_add_arc_of_ellipse.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_add_arc_of_ellipse_contract.py"],
            cwd=root,
            check=False,
        )
