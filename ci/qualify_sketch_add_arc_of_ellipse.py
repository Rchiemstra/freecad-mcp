...
PYTHON_TESTS = (
    "tests/test_sketch_add_arc_of_ellipse.py",
    "tests/test_sketch_add_arc_of_ellipse_response.py",
    "tests/test_sketch_add_arc_of_ellipse_contract_gate.py",
    "tests/test_sketch_add_arc_of_ellipse_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_arc_of_ellipse.py",)
    else:
