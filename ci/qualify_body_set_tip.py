"""Repeatable acceptance lanes for the typed ``body_set_tip`` implementation.
...
A missing native runtime is an error, not a skip.
"""
...
def main() -> int:
    ...
    if args.native:
        try:
            ...
            raise RuntimeError(
                "Native qualification requires a real branch-built FreeCAD"
            ) from exc
