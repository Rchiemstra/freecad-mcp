...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_equal.py",
    "tests/test_sketch_constrain_equal_response.py",
    "tests/test_sketch_constrain_equal_contract_gate.py",
    "tests/test_sketch_constrain_equal_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_equal.py",)
    else:
