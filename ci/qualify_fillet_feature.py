...
PYTHON_TESTS = (
    "tests/test_fillet_feature.py",
    "tests/test_fillet_feature_response.py",
    "tests/test_fillet_feature_contract_gate.py",
    "tests/test_fillet_feature_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_fillet_feature.py",)
    else:
