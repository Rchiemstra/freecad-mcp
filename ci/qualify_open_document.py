...
PYTHON_TESTS = (
    "tests/test_open_document.py",
    "tests/test_open_document_response.py",
    "tests/test_open_document_contract_gate.py",
    "tests/test_open_document_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_open_document.py",)
    else:
