...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_horizontal.py",
    "tests/test_sketch_constrain_horizontal_response.py",
    "tests/test_sketch_constrain_horizontal_contract_gate.py",
    "tests/test_sketch_constrain_horizontal_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_horizontal.py",)
    else:
