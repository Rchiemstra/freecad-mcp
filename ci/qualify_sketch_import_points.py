...
PYTHON_TESTS = (
    "tests/test_sketch_import_points.py",
    "tests/test_sketch_import_points_response.py",
    "tests/test_sketch_import_points_contract_gate.py",
    "tests/test_sketch_import_points_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_import_points.py",)
    else:
