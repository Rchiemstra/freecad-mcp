"""Repeatable acceptance lanes for the typed ``sketch_import_points`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_import_points.py",
    "tests/sketch/test_sketch_import_points_response.py",
    "tests/sketch/test_sketch_import_points_contract_gate.py",
    "tests/sketch/test_sketch_import_points_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_import_points.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_import_points_contract.py"],
            cwd=root,
            check=False,
        )
