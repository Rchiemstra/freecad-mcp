...
PYTHON_TESTS = (
    "tests/test_preview_attachment.py",
    "tests/test_preview_attachment_response.py",
    "tests/test_preview_attachment_contract_gate.py",
    "tests/test_preview_attachment_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_preview_attachment.py",)
    else:
