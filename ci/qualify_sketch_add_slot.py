...
PYTHON_TESTS = (
    "tests/test_sketch_add_slot.py",
    "tests/test_sketch_add_slot_response.py",
    "tests/test_sketch_add_slot_contract_gate.py",
    "tests/test_sketch_add_slot_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_slot.py",)
    else:
