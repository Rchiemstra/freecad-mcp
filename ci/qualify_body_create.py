"""Repeatable acceptance lanes for the Body creation reference implementation.
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_collaboration_api.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_body_create_contract.py"],
            cwd=root,
            check=False,
        )
