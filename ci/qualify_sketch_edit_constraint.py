"""Repeatable acceptance lanes for the typed ``sketch_edit_constraint`` implementation.
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_edit_constraint.py",
    "tests/sketch/test_sketch_edit_constraint_response.py",
    "tests/sketch/test_sketch_edit_constraint_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/sketch/test_sketch_edit_constraint_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_edit_constraint.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_edit_constraint_contract.py"],
            cwd=root,
            check=False,
        )
