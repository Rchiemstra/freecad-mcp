...
PYTHON_TESTS = (
    "tests/test_sketch_edit_constraint.py",
    "tests/test_sketch_edit_constraint_response.py",
    "tests/test_sketch_edit_constraint_contract_gate.py",
    "tests/test_typed_platform_discovery.py",
    "tests/test_sketch_edit_constraint_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_edit_constraint.py",)
    else:
