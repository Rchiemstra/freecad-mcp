...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_radius.py",
    "tests/test_sketch_constrain_radius_response.py",
    "tests/test_sketch_constrain_radius_contract_gate.py",
    "tests/test_sketch_constrain_radius_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_radius.py",)
    else:
