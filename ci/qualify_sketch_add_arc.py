...
PYTHON_TESTS = (
    "tests/test_sketch_add_arc.py",
    "tests/test_sketch_add_arc_response.py",
    "tests/test_sketch_add_arc_contract_gate.py",
    "tests/test_sketch_add_arc_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_arc.py",)
    else:
