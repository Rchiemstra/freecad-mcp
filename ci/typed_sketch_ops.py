...
SKETCH_OPS: tuple[SketchOpSpec, ...] = (
    _spec(
        ...
        template="src/freecad_mcp/templates/core/sketch_add_line.py.txt",
    ...
    _spec(
        "sketch_add_circle",
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/core/sketch_add_circle.py.txt",
        register_module="tools_sketch_primitives",
    ...
    _spec(
        "sketch_add_arc",
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/core/sketch_add_arc.py.txt",
        register_module="tools_sketch_primitives",
    ...
    _spec(
        ...
        template="src/freecad_mcp/templates/core/sketch_add_rectangle.py.txt",
        register_module="tools_sketch_primitives",
    ...
    _spec(
        "sketch_add_ellipse",
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_ellipse.py.txt",
    ...
    _spec(
        ...
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_arc_of_ellipse.py.txt",
        register_module="tools_sketch_curves_a2",
    ...
    _spec(
        "sketch_add_slot",
        success_kind="geometry_indices",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_slot.py.txt",
        register_module="tools_sketch_curves_a2",
    ...
    _spec(
        "sketch_add_polyline",
        success_kind="geometry_indices",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_polyline.py.txt",
    ...
    _spec(
        "sketch_add_bspline",
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_bspline.py.txt",
        register_module="tools_sketch_curves_a",
    ...
    _spec(
        ...
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_bspline_through_points.py.txt",
        register_module="tools_sketch_curves_a",
    ...
    _spec(
        "sketch_add_bezier",
        success_kind="geometry_index",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_bezier.py.txt",
        register_module="tools_sketch_curves_a",
    ...
    _spec(
        ...
        success_kind="geometry_indices",
        template="src/freecad_mcp/templates/p1_curves/sketch_add_regular_polygon.py.txt",
    ...
    _spec(
        ...
        template="src/freecad_mcp/templates/p1_curves/sketch_add_parametric_curve.py.txt",
        register_module="tools_sketch_curves_b",
    ...
    _spec(
        ...
        success_kind="geometry_indices",
        template="src/freecad_mcp/templates/p1_curves/sketch_import_points.py.txt",
        register_module="tools_sketch_curves_b",
    ...
    _spec(
        ...
        template="src/freecad_mcp/templates/p1_curves/sketch_toggle_construction.py.txt",
        register_module="tools_sketch_curves_b",
    ...
    _spec(
        ...
        template="src/freecad_mcp/templates/core/run_constraint.py.txt",
    ...
    _spec(
        "sketch_trim",
        success_kind="sketch_only",
        template="src/freecad_mcp/templates/p2_editing/sketch_trim.py.txt",
    ...
    _spec(
        "sketch_extend",
        success_kind="sketch_only",
        template="src/freecad_mcp/templates/p2_editing/sketch_extend.py.txt",
        register_module="tools_sketch_curves_b2",
    ...
    _spec(
        "sketch_split",
        success_kind="sketch_only",
        template="src/freecad_mcp/templates/p2_editing/sketch_split.py.txt",
        register_module="tools_sketch_curves_b2",
    ...
    _spec(
        "sketch_fillet",
        success_kind="sketch_only",
        template="src/freecad_mcp/templates/p2_editing/sketch_fillet.py.txt",
        register_module="tools_sketch_curves_b2",
    ...
    _spec(
        "sketch_symmetry",
        success_kind="sketch_only",
        template="src/freecad_mcp/templates/p2_editing/sketch_symmetry.py.txt",
        register_module="tools_sketch_curves_b2",
