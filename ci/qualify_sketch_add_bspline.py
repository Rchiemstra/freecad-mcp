...
PYTHON_TESTS = (
    "tests/test_sketch_add_bspline.py",
    "tests/test_sketch_add_bspline_response.py",
    "tests/test_sketch_add_bspline_contract_gate.py",
    "tests/test_sketch_add_bspline_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_bspline.py",)
    else:
