"""Repeatable acceptance lanes for the typed ``sketch_extend`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_extend.py",
    "tests/sketch/test_sketch_extend_response.py",
    "tests/sketch/test_sketch_extend_contract_gate.py",
    "tests/sketch/test_sketch_extend_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_extend.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_extend_contract.py"],
            cwd=root,
            check=False,
        )
