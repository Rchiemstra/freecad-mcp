...
PYTHON_TESTS = (
    "tests/test_sketch_extend.py",
    "tests/test_sketch_extend_response.py",
    "tests/test_sketch_extend_contract_gate.py",
    "tests/test_sketch_extend_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_extend.py",)
    else:
