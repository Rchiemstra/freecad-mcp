...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_vertical.py",
    "tests/test_sketch_constrain_vertical_response.py",
    "tests/test_sketch_constrain_vertical_contract_gate.py",
    "tests/test_sketch_constrain_vertical_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_vertical.py",)
    else:
