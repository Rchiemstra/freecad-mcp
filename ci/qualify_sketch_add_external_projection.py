...
PYTHON_TESTS = (
    "tests/test_sketch_add_external_projection.py",
    "tests/test_sketch_add_external_projection_response.py",
    "tests/test_sketch_add_external_projection_contract_gate.py",
    "tests/test_sketch_add_external_projection_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_external_projection.py",)
    else:
