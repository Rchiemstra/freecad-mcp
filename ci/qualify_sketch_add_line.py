...
PYTHON_TESTS = (
    "tests/test_sketch_add_line.py",
    "tests/test_sketch_add_line_response.py",
    "tests/test_sketch_add_line_contract_gate.py",
    "tests/test_sketch_add_line_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_line.py",)
    else:
