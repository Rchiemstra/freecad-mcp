"""Repeatable acceptance lanes for the typed ``sketch_fillet`` mutation."""
...
PYTHON_TESTS = (
    "tests/sketch/test_sketch_fillet.py",
    "tests/sketch/test_sketch_fillet_response.py",
    "tests/sketch/test_sketch_fillet_contract_gate.py",
    "tests/sketch/test_sketch_fillet_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_sketch_fillet.py",)
    else:
        result = subprocess.run(
            [sys.executable, "ci/check_sketch_fillet_contract.py"],
            cwd=root,
            check=False,
        )
