...
PYTHON_TESTS = (
    "tests/test_sketch_fillet.py",
    "tests/test_sketch_fillet_response.py",
    "tests/test_sketch_fillet_contract_gate.py",
    "tests/test_sketch_fillet_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_fillet.py",)
    else:
