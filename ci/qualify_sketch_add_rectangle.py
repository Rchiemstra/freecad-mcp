...
PYTHON_TESTS = (
    "tests/test_sketch_add_rectangle.py",
    "tests/test_sketch_add_rectangle_response.py",
    "tests/test_sketch_add_rectangle_contract_gate.py",
    "tests/test_sketch_add_rectangle_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_rectangle.py",)
    else:
