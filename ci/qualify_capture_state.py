...
PYTHON_TESTS = (
    ...
    "tests/test_capture_state_response.py",
    "tests/test_capture_state_contract_gate.py",
    "tests/test_capture_state_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_capture_state.py",)
    else:
