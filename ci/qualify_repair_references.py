...
PYTHON_TESTS = (
    "tests/test_repair_references.py",
    "tests/test_repair_references_response.py",
    "tests/test_repair_references_contract_gate.py",
    "tests/test_repair_references_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_repair_references.py",)
    else:
