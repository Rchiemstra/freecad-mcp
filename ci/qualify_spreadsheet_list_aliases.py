...
PYTHON_TESTS = (
    "tests/spreadsheet/test_spreadsheet_list_aliases.py",
    "tests/spreadsheet/test_spreadsheet_list_aliases_response.py",
    "tests/spreadsheet/test_spreadsheet_list_aliases_contract_gate.py",
    "tests/spreadsheet/test_spreadsheet_list_aliases_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_spreadsheet_list_aliases.py",)
    else:
