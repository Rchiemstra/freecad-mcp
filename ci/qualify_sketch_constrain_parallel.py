...
PYTHON_TESTS = (
    "tests/test_sketch_constrain_parallel.py",
    "tests/test_sketch_constrain_parallel_response.py",
    "tests/test_sketch_constrain_parallel_contract_gate.py",
    "tests/test_sketch_constrain_parallel_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_constrain_parallel.py",)
    else:
