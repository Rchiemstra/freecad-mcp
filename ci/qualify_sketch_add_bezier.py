...
PYTHON_TESTS = (
    "tests/test_sketch_add_bezier.py",
    "tests/test_sketch_add_bezier_response.py",
    "tests/test_sketch_add_bezier_contract_gate.py",
    "tests/test_sketch_add_bezier_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_bezier.py",)
    else:
