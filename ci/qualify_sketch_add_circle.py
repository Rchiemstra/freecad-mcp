...
PYTHON_TESTS = (
    "tests/test_sketch_add_circle.py",
    "tests/test_sketch_add_circle_response.py",
    "tests/test_sketch_add_circle_contract_gate.py",
    "tests/test_sketch_add_circle_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_sketch_add_circle.py",)
    else:
