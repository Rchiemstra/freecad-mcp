...
PYTHON_TESTS = (
    "tests/create_placement/test_create_placement_datum.py",
    "tests/create_placement/test_create_placement_datum_response.py",
    "tests/create_placement/test_create_placement_datum_contract_gate.py",
    "tests/create_placement/test_create_placement_datum_json_rpc_contract.py",
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/native/test_native_create_placement_datum.py",)
    else:
