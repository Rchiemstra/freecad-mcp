...
PYTHON_TESTS = (
    "tests/test_delete_object.py",
    "tests/test_delete_object_response.py",
    "tests/test_delete_object_contract_gate.py",
    "tests/test_delete_object_json_rpc_contract.py",
)
...
def main() -> int:
    ...
    if args.native:
        ...
        tests = ("tests/test_native_delete_object.py",)
    else:
