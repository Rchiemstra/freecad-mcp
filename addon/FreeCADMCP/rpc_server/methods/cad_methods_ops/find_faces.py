...
def run_find_faces(collaborators: object, doc_name: str, object_name: str) -> dict[str, object]:
    ...
    try:
        payload = diagnostics_shape_actions.find_subshapes(document, object_name, "Faces")
...
def rpc_find_faces(self: _RpcFacade, doc_name: str, object_name: str) -> dict[str, object]:
    res = self._dispatch_gui(lambda: run_find_faces(self._cad_collaborators, doc_name, object_name))
