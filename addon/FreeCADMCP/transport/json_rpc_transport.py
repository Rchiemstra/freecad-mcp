...
try:
    ...
    from .._shared.protocol.json_rpc import JsonRpcFramingError as _JsonRpcFramingError
    from .._shared.protocol.json_rpc import (
    ...
    from .._shared.protocol.json_rpc import json_rpc_error as _json_rpc_error
    from .._shared.protocol.json_rpc import json_rpc_success as _json_rpc_success
...
class JsonRpcTransport:
    ...
    def _handle_item(self, request: _Any) -> dict[str, _Any] | None:
        ...
        except Exception as exc:  # opaque transport boundary
        ...
        if self._exception_to_error is not None:
            try:
                ...
                if mapped is not None:
                    ...
                    return mapped
            except Exception as mapper_exc:  # mapper is untrusted
                _logger.error(
