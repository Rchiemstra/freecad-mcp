...
class DocumentIdentityService:
    ...
    def registered_session_uuid(self, document: Any) -> str:
    ...
    def refresh_saved_document(self, document: Any) -> DocumentIdentity:
        ...
        with self._lock:
            ...
            if not candidates:
                raise DocumentIdentityError(
                    "at least one document selector is required"
                )
